...
var bar_textures = {
"green": preload("res://space_rocks_assets/assets/bar_green_200.png"),
"yellow": preload("res://space_rocks_assets/assets/bar_yellow_200.png"),
"red": preload("res://space_rocks_assets/assets/bar_red_200.png")
}
...
func update_lives(value):
	for index in 3:
		lives_counter[index].visible = value > index
